...
.pull-left[
- Danish industrialisation is the industrialisation of agriculture (Sharp & Lampe, 2019)
...
- Potential influence measured as market potential of IM
]
...
---
# Different naming practices after conflict (table 1)
```{r echo=FALSE, out.width="80%", fig.align='center'}
knitr::include_graphics("Figures/OLS_WP2.png")
```

---
# Did this language difference cause differential occupational outcomes? (table 4)
